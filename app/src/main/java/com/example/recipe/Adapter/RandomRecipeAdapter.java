...
public class RandomRecipeAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder>{
    ...
    public void onBindViewHolder(@NonNull RandomRecipeViewHolder holder, int position) {
        ...
        holder.random_list_adapter.setOnClickListener(new View.OnClickListener() {
            @Override
...
class RandomRecipeViewHolder extends RecyclerView.ViewHolder{
    CardView random_list_adapter;
    TextView textView_title,textView_likes,textView_servings,textView_time;
    ImageView imageView_food;

    public RandomRecipeViewHolder(@NonNull View itemView) {
        super(itemView);
        random_list_adapter=itemView.findViewById(R.id.random_list_container);
